...
class AdminAddImage extends StatefulWidget {
  const AdminAddImage(this.addImageFunc, {Key? key}) : super(key: key);

  final Function(File PickedImage) addImageFunc; // put picked image into function to transfer to main screen page

  @override
  State<AdminAddImage> createState() => _AddImageState();
}

class _AddImageState extends State<AdminAddImage> {
